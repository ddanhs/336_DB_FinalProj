...
SELECT start_station_id AS 'Station', MAX(tripduration) AS 'Max Duartion' , MIN(tripduration) AS 'Min Duration', COUNT(start_station_id) AS 'Average Users'
FROM citi
GROUP BY start_station_id
ORDER BY Station;

SELECT DISTINCT start_station_id AS 'Station',
...
SELECT DATENAME(WEEKDAY, starttime) AS 'Week Day' , start_station_id AS 'Start Station', end_station_id AS 'End Station', COUNT(*) AS 'MAX # Of Trips'
FROM citi  
WHERE (DATEPART(WEEKDAY, starttime) = @WeekdaySearch)
GROUP BY DATENAME(WEEKDAY, starttime), start_station_id, end_station_id
HAVING COUNT(*) = ( 
				SELECT MAX(cnt)
				FROM ( SELECT start_station_id AS 'Start Station', end_station_id AS 'End Station', COUNT(*) cnt
						FROM citi
						WHERE (DATEPART(WEEKDAY, starttime) = @WeekdaySearch)
...
SELECT DATENAME(WEEKDAY, starttime), start_station_id AS 'Start Station', end_station_id AS 'End Station', COUNT(*) AS '# Of Trips'
FROM citi  
...
GROUP BY c.start_station_id, c.start_station_id, z.ZIP;
